 ...
 *        概    要: 简单的汉语转拼音类
 *        作    者: IT小强
 *        创建时间: 5/18/20 2:28 PM
 *        修改时间:
 *        copyright (c) 2016 - 2020 mail@xqitw.cn
 *  ==================================================================
 */

namespace itxq\pinyin;
...
class PinYin
{
     ...
     * @return string
     */
    public function turnFirst(string $chinese, bool $ucFirst = false, $delimiter = '', $charset = 'utf-8')
    {
        return $this->turn($chinese, true, $ucFirst, $delimiter, $charset);
    }

    /**
     * 获取文字的拼音
     * @param string  $chinese   中文汉字
     * @param boolean $onlyFirst 是否仅取拼音第一个字母
     * @param boolean $ucFirst   是否首字母大写
     * @param string  $delimiter 拼音之间的分隔符(可选 - _ 或者空)
     * @param string  $charset   文字编码
     * @return string
     */
    public function turn(string $chinese, bool $onlyFirst = false, bool $ucFirst = false, $delimiter = '', $charset = 'utf-8'): string
    {
        $chinese = preg_replace('/\s/', '', $chinese);
     ...
     * @return string
     */
    protected function turnGBK(string $str): string
    {
